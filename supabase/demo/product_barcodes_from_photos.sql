...
VALUES
    ('8901138511975', 'Himalaya herbal tablets', 'Himalaya', NULL,
     'Himalaya Wellness Company', 'ayurvedic', 'AYUSH', TRUE, '100 tablets', 215.00,
     'demo_manual_from_photos',
     'Product name not visible in photo. Label says it protects the liver against hepatotoxins; ingredients include Himsra and Kasani. Label: Mfg 04/2025, Exp 03/2028.'),
