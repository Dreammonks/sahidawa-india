-- =============================================================================
-- Reference copy of apps/api/src/db/schema.sql, taken 2026-09-16
-- =============================================================================
-- This file, not supabase/migrations/, is the real definition of the tables the
-- ETL writes to. It declares medicines.barcode_id and the columns strength,
-- dosage_form, schedule and source, none of which any migration creates.
--
-- Kept here because apps/api is being cut down to the barcode endpoint, and the
-- single clean migration has to be built from this. Reference only: nothing
-- runs it.
-- =============================================================================
